...
public class Dumper {
    ...
    public static DumpTable toDumpData(Object o){
        ...
        for (int i=0; i<methods.length; i++){
            ...
            methodDump.appendRow(0,
                    new DumpString(DumpString.toClassName(method.getReturnType())),
                    new DumpString(sbParameters.toString()),
                    new DumpString(sbExceptions.toString())
            );
        }
        if (methods.length > 0)
